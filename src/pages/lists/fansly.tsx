...
import { fanslyhandles } from '../../utils/fanslyhandles';
...
const FanslyPage = () => {
  ...
  return (
    <Lists
      meta={
        <Meta
          title="Videas.me fansly list"
          description="videas.me fansly list."
        />
      }
    >
      <section className="relative flex flex-wrap">
        ...
        <div className="relative w-full h-64 sm:h-96 lg:w-1/2 lg:h-auto">
          {isLoggedIn && <SearchArray array={fanslyhandles} />}
        </div>
      </section>
    </Lists>
  );
